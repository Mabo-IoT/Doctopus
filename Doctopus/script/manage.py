...
if __name__ == '__main__':
    ...
    parse.add_argument('-a', '--action', action='store', default='run', help='Run the project')
    parse.add_argument('-v', '--version', action='version', default=None, version='%(prog)s 0.1.0')
    parse.add_argument('-t', '--target', default='client', choices=['server', 'client'], help='default run client')
